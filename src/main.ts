function main(cvs: HTMLCanvasElement) {
    ...
    let plane = new Plane(origin, vector, { r: 0.4, g: 0.8, b: 0.4, albedo: 1, reflectivity: 0.1 })
    scene.add(plane)
    origin = new Vector3(0, 0.25, -2)
    let sphere = new Sphere(origin, 0.5, { r: 0.8, g: 0.8, b: 0.8, albedo: 1, reflectivity: 0.8 })
    scene.add(sphere)

    origin = new Vector3(0.75, 0.75, -1.25)
    sphere = new Sphere(origin, 0.75, { r: 1, g: 0.4, b: 0.4, albedo: 1, reflectivity: 0.2 })
    scene.add(sphere)

    origin = new Vector3(-1, 1, -3)
    sphere = new Sphere(origin, 1, { r: 0.4, g: 0.4, b: 1, albedo: 1, reflectivity: 0.3 })
    scene.add(sphere)
